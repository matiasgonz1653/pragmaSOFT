...
export default function DogCreate(){ 
    ...
    //const serieSelect = useSelector((state)=> state.detailSerie)
    const [errors, setErrors] = useState({})
    
    
    const serieSelect = allseries.find((s) => s.id === id);
    console.log("serie del state",serieSelect);
    

    
    const [input, setInput] = useState({
        id:serieSelect.id,
        name: serieSelect.name ,                                   
        description: serieSelect.description,
        date:serieSelect.date,
        stars: serieSelect.stars,
        gender:serieSelect.gender, 
    ...
    return(
        <div className="fondo">
            ...
            <h1 className="tituleCrear">Modificar serie</h1> 
